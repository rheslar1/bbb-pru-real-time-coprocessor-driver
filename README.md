...
cmake -S . -B build
cmake --build build
./build/bbb_pru_real_time_coprocessor_driver
...
Intended public repository: https://github.com/rheslar1/bbb-pru-real-time-coprocessor-driver
...
This repository includes a structured design package for **BBB Real-Time PRU Co-Processor Driver**. The package captures the system boundary, runtime flow, hardware/software interfaces, validation strategy, and implementation roadmap.
