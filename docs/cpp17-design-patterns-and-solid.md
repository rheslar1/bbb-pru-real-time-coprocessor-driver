...
```bash
./build/bbb_real_time_pru_co_processor_driver --nominal
./build/bbb_real_time_pru_co_processor_driver --unsafe
./build/bbb_real_time_pru_co_processor_driver --offline
```
