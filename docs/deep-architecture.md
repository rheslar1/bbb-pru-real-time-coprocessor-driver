# BBB Real-Time PRU Co-Processor Driver Deep Architecture
...
C++17, C++ Design Patterns, SOLID, BeagleBone Black, PRU, rpmsg, Kernel driver, Real-time control, Encoder input
