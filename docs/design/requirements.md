...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for BBB Real-Time PRU Co-Processor Driver. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: BeagleBone Black PRU project that runs timing-critical firmware on the 200MHz PRUs and exchanges high-speed sensor or encoder data with Linux through rpmsg. | Scenario tests and documentation review. |
